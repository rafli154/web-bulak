...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "SELECT p.id_pengajuan, u.nama AS nama_user, u.alamat AS alamat_user, k.jenis_pengajuan AS kategori, p.tanggal_pengajuan, p.status 
            FROM pengajuan p
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        header("Location: ../pengajuan_user.php?keterangan=pengajuan-skps-success");
        exit;
    } else {
    ...
    <section id="content">
        ...
        <main>
            <div class="head-title">
                <div class="left">
                    <h1>Pengajuan Surat Keterangan Penduduk Sementara</h1>
                    <ul class="breadcrumb">
                        <li><a href="index.php">Admin</a></li>
                        <li><i class='bx bx-chevron-right'></i></li>
                        <li><a href="index.php">Pengajuan User</a></li>
                        <li><i class='bx bx-chevron-right'></i></li>
                        <li><a class="active" href="pengajuan_user.php">SKPS</a></li>
                    </ul>
                </div>
            </div>
            <div class="table-data">
                <div class="order">
                        ...
                        <form action="skps.php" method="POST">
                            ...
                            <h3 style="margin-bottom:10px; font-size:20px; font-weight: 600;">Menyatakan kependudukan sementara pada: </h3>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-column">
                                    ...
                                    <div class="data-user">
                                        ...
                                        <input type="text" id="masa_berlaku" value="Berlaku 1 bulan setelah pengajuan." disabled>
                                    </div>
                                </div>
                            </div>
