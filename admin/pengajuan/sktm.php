...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "SELECT p.id_pengajuan, u.nama AS nama_user, k.jenis_pengajuan AS kategori, p.tanggal_pengajuan, p.keterangan_tidak_mampu, p.status 
            FROM pengajuan p
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        header("Location: ../pengajuan_user.php?keterangan=pengajuan-sktm-success");
        exit;
    } else {
    ...
    <section id="content">
        ...
        <main>
            <div class="head-title">
                <div class="left">
                    <h1>Pengajuan Surat Keterangan Tidak Mampu</h1>
                    <ul class="breadcrumb">
                        <li><a href="index.php">Admin</a></li>
                        <li><i class='bx bx-chevron-right'></i></li>
                        <li><a href="index.php">Pengajuan User</a></li>
                        <li><i class='bx bx-chevron-right'></i></li>
                        <li><a class="active" href="pengajuan_user.php">SKTM</a></li>
                    </ul>
                </div>
            </div>
            <div class="table-data">
                <div class="order">
                        ...
                        <form action="sktm.php" method="POST">
                            ...
                            <h3 style="margin-bottom:10px; font-size:20px; font-weight: 600;">Menyatakan: </h3>

                            <div class="form-row">
                                <div class="form-column">
                                    <div class="data-user">
                                        <label for="keterangan_tidak_mampu">Keterangan:</label>
                                        <input type="text" id="keterangan_tidak_mampu" value="<?php echo htmlspecialchars($row['keterangan_tidak_mampu'] ?? ''); ?>" disabled>
                                    </div>
                                </div>
                                <div class="form-column">
                                    <div class="data-user">
