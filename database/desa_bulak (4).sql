...
--
-- Host: localhost
-- Waktu pembuatan: 02 Agu 2024 pada 08.46
...
INSERT INTO `kritik_saran` (`id_kritik_saran`, `nama`, `email`, `isi`, `status`) VALUES
(1, 'Anggi Maulana', 'anggabos@gmail.com', 'Pastikan untuk menggunakan variabel yang benar ($_POST[\"kritik_saran\"] atau $_POST[\"kritik_dan_saran\"]) di bagian PHP.\r\nPastikan nama ID dan nama input dalam form HTML konsisten dengan yang digunakan dalam PHP.', 'Belum Dibaca');
...
(69, '3212131307050003', 5, NULL, NULL, NULL, NULL, NULL, NULL, '2024-08-01', '2024-08-29', 'Acc', 'Anggi Maulana', NULL),
