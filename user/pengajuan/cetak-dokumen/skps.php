<?php 
    ...
    if ($result2 && mysqli_num_rows($result2) > 0) {
        ...
        $nomor_skps = $data_pengajuan['id_pengajuan'];
        $nomor_surat_berikutnya_padded = str_pad($nomor_skps, 3, '0', STR_PAD_LEFT);
    } else {
    ...
    $jumlah_sk = "SELECT COUNT(*) AS total FROM pengajuan where id_kategori = 4";
