                        ...
                        <form id="pengajuanForm" action="proses/sk.php" method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-column">
                                    ...
                                    <div class="data-user">
                                        <label for="keterangan_menikah">Keterangan</label>
                                        <select name="keterangan_menikah" id="keterangan_menikah">
                                        ...
                                        <!-- <input type="text" name="keterangan_menikah" id="keterangan_menikah" required> -->
                                    </div>
                                </div>
                            </div>
