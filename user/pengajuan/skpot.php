        ...
        <div class="table-data">
            <div class="order">
                <div class="formulir-pengajuan"  id="pengajuanForm">
                    <form action="proses/skpot.php" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-column">
                                ...
                                <div class="data-user">
                                    <label for="nik_ortu">NIK</label>
                                    <input type="number" name="nik_ortu" id="nik_ortu" required>
                                </div>
                                <div class="data-user">
                            ...
                            <div class="form-column">
                                ...
                                <div class="data-user">
                                    ...
                                    <input type="text" name="jk" id="jk" value="<?php echo $userData['jenis_kelamin']; ?>" required>
                                </div>
                                <div class="data-user">
